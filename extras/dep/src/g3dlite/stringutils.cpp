...
std::string toUpper(const std::string& x) { // patché pour compilation linux par Franck
	std::string result = x;
...
std::string toLower(const std::string& x) { // patché pour compilation linux par Franck
	std::string result = x;
