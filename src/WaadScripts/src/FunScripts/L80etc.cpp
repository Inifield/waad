...
public:
	...
	void AIUpdate()
	{
		switch (timer)
		{
			case 2: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLLLIGHTNING), true);
				    _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLLLIGHTNING2), true);
			        break;
			case 6: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLEARTH), true);
			        break;
			case 8: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLFIRE), true);
			        break;
			case 72: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLLLIGHTNING), true);
				     _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLLLIGHTNING2), true);
			         break;
			case 76: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLEARTH), true); 
				     break;
			case 78: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLFIRE), true);
			         break;
			case 125: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLLLIGHTNING), true);
				      _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLLLIGHTNING2), true);
			          break; 
			case 128: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLEARTH), true);
			          break;
			case 132: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLFIRE), true);
			          break;
			case 232: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLLLIGHTNING), true);
				      _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLLLIGHTNING2), true);
			          break;
			case 236: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLEARTH), true);
			          break;
			case 238: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLFIRE), true);
			          break;   
            case 245: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLLLIGHTNING), true);
				      _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLLLIGHTNING2), true);
			          break;
			case 249: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLEARTH), true);
			          break;
			case 251: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLFIRE), true);
			          break;
			case 279: _unit->CastSpell(_unit, dbcSpell.LookupEntry(SPELLFLARE), true);
			          break;
			case 280: _unit->Despawn(1000,300000);
			          break;
		}
		timer++;
	}
