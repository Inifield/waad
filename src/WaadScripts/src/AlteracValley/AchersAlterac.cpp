...
#define FRANC_ARCHERS_FOUDRE 13358 //Archers de l'alliance
#define FRANC_ARCHERS_LOUP 13359 //Archers de la horde

#define SHOOT 22121 // Tir

class FRANCARCHERS: public CreatureAIScript
{
public:
	ADD_CREATURE_FACTORY_FUNCTION(FRANCARCHERS);
	SP_AI_Spell spells[1];
	bool m_spellcheck[1];

    FRANCARCHERS(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		nrspells = 1;
...
{
	mgr->register_creature_script(FRANC_ARCHERS_FOUDRE, &FRANCARCHERS::Create);
	mgr->register_creature_script(FRANC_ARCHERS_LOUP, &FRANCARCHERS::Create);
}
