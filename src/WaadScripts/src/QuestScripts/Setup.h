...
//  ### Waad ###
void SetupQueteLivreAnciens(ScriptMgr * mgr);   // Franck77
void SetupQueteEpreuveLegion(ScriptMgr * mgr);  // Franck77
void SetupQueteArikara(ScriptMgr * mgr);        // BB
void SetupScarletEnclave(ScriptMgr * mgr);		// Crash
void SetupToundraBoreenne(ScriptMgr * mgr);		// Crash
void SetupZulDrak(ScriptMgr * mgr);				// Crash
void SetupLespicsfoudroyes(ScriptMgr * mgr);	// Crash
void SetupLesgrisonnes(ScriptMgr * mgr);		// Crash
void SetupLacouronnedeglace(ScriptMgr * mgr);	// Crash
void SetupJougdhiver(ScriptMgr * mgr);			// Crash
void SetupForetduchantdecristal(ScriptMgr * mgr);	// Crash
void SetupFjordhurlant(ScriptMgr * mgr);		// Crash
void SetupDesolationdesdragons(ScriptMgr * mgr);	// Crash
void SetupDalaran(ScriptMgr * mgr);				// Crash
void SetupBassindesholazar(ScriptMgr * mgr);	// Crash
void SetupTeldrassil(ScriptMgr *mgr);           // Branruz
//	###		Misc	###
