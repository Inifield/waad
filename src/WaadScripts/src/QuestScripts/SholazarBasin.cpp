/*
 * ArcEmu Scripts for Ascent MMORPG Server
...
#define TAMARA 28568
#define GOSSIP_TASTETEST "Oserez vous essayer le punch de Grimbooze Thunderbrew's Jungle ?"
	...
	public:
		...
		void GossipSelectOption(Object* pObject, Player* plr, uint32 Id, uint32 IntId, const char* Code)
		{
			...
			switch(IntId)
			{
				case 1:
					{
						string msg = "Aye, Je vais essayer !";
						pCreature->SendChatMessage(CHAT_MSG_MONSTER_SAY, LANG_UNIVERSAL, msg.c_str());
						string msg2 = "C'est exactement ce dont j'ai besoin!";
						string msg3 = "Je vote pour ! Il vous met la tête à l'envers comme rien d'autre au monde.";
						pCreature->SendChatMessage(CHAT_MSG_MONSTER_SAY, LANG_UNIVERSAL, msg2.c_str());
						pCreature->SendChatMessage(CHAT_MSG_MONSTER_SAY, LANG_UNIVERSAL, msg3.c_str());
