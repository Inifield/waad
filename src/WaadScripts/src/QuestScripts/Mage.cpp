...
// Pas necessaire, sauf pour du debug de code avant Build global
// Sinon priere de laisser en commentaire (Branruz)
//#define MAX_AURAS           96 // 56
//#define MAX_POSITIVE_AURAS  40
//#define MAX_PASSIVE_AURAS   192
...
public:
  ...
  void AIUpdate()
  {
    ...
    //for(int i = 0; i<MAX_AURAS+MAX_PASSIVE_AURAS2; i++)
