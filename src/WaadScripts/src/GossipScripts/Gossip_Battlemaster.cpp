/*
 * Modifié Waad for Ascent MMORPG Server
 * Moon++ Scripts for Ascent MMORPG Server
 * Copyright (C) 2005-2007 Ascent Team <http://www.ascentemu.com/>
 * Copyright (C) 2007-2008 Moon++ Team <http://www.moonplusplus.info/>
 * Copyright (C) 2008-2009 Waad   Team <http://arbonne.games-rpg.net/>
 *
...
public:
    void GossipHello(Object* pObject, Player * plr, bool AutoSend)
    {
        ...
        else
        {
           ...
           objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), FactMessages[Team], plr);
           Menu->AddItem( 0, "Je voudrais me rendre dans le goulet des Chanteguerres.", 1);
        }
...
public:
    void GossipHello(Object* pObject, Player * plr, bool AutoSend)
    {
        ...
        else
        {
            ...
            // Send "you cannot enter" message.
            objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), FactMessages[Team], plr);
            Menu->AddItem( 0, "Je voudrais me rendre dans le bassin d'Arathi.", 1);
        }
...
public:
    void GossipHello(Object* pObject, Player * plr, bool AutoSend)
	{
        ...
        else
        {
            ...
            // Send "you cannot enter" message.
            objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), FactMessages[Team], plr);
            Menu->AddItem( 0, "Je voudrais me rendre dans la vallée d'Alterac.", 1);
        }
...
public:
    void GossipHello(Object* pObject, Player * plr, bool AutoSend)
    {
        ...
        else
        {
            ...
            objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), FactMessages[Team], plr);
            Menu->AddItem( 0, "Je voudrais me rendre à l'Oeil du Cyclone.", 1);
        }
    ...
    {
        // Send battleground list.
		if(pObject->GetTypeId()!=TYPEID_UNIT) return;
...
class SOTABattlemaster : public GossipScript
{
public:
    void GossipHello(Object* pObject, Player * plr, bool AutoSend)
    {
        ...
        else
        {
            ...
            objmgr.CreateGossipMenuForPlayer(&Menu, pObject->GetGUID(), FactMessages[Team], plr);
            Menu->AddItem( 0, "Je voudrais me rendre au rivage des Anciens.", 1);
        }
    ...
    void GossipSelectOption(Object* pObject, Player * plr, uint32 Id, uint32 IntId, const char * Code)
    {
        // Send battleground list.
		if(pObject->GetTypeId()!=TYPEID_UNIT) return;
        plr->GetSession()->SendBattlegroundList(((Creature*)pObject), 9);  // SOTA = 9
    }
...
void SetupBattlemaster(ScriptMgr * mgr)
{
	...
	// GossipScript * sota = (GossipScript*) new SOTABattlemaster;
