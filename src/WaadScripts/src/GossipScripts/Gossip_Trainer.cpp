...
// Hammersmith
#define FRK_GOSSIP_HLEARN    "Lilith, apprenez-moi s'il te plaît à devenir un Forgeron de Marteau."
#define FRK_GOSSIP_HULEARN   "Je veux désapprendre Forgeron de Marteau!"
// Swordsmith
#define FRK_GOSSIP_SLEARN    "Seril, apprenez-moi s'il te plaît à devenir un Forgeron d'Epée."
#define FRK_GOSSIP_SULEARN   "Je veux désapprendre Forgeron d'Epée!"
// Axesmith
#define FRK_GOSSIP_ALEARN    "Kilram, apprenez-moi s'il te plaît à devenir un Forgeron de Hache."
#define FRK_GOSSIP_AULEARN   "Je veux désapprendre Forgeron de Hache!"
...
public:
    void GossipHello(Object * pObject, Player * plr, bool AutoSend)
    {
		...
		Menu->AddItem( 0, FRK_GOSSIP_HLEARN , 1);
		Menu->AddItem( 0, FRK_GOSSIP_HULEARN , 2);
...
// boulet or not ? :)        
		Menu->AddItem( 0, FRK_GOSSIP_SLEARN , 1);
		Menu->AddItem( 0, FRK_GOSSIP_SULEARN , 2);
...
public:
    void GossipHello(Object * pObject, Player * plr, bool AutoSend)
    {
		...
		Menu->AddItem( 0, FRK_GOSSIP_ALEARN , 1);
		Menu->AddItem( 0, FRK_GOSSIP_AULEARN , 2);
