...
// Trenton Lighthammer
#define GOSSIP_SILVA_FILNAVETH    "Je voudrais voler vers le Village Rut'theran."
...
// Bunthen Plainswind
#define GOSSIP_BUNTHEN_PLAINSWIND    "Je voudrais voler vers les Pitons du Tonerre."
