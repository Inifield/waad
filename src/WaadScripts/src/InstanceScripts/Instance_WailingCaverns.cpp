...
#define SAY_AGGROLADY               "Nul ne peut s’opposer au seigneur serpent!"
...
#define SAY_AGGROCOBRAHN            "Vous n’éveillerez pas le rêveur!"
...
#define SAY_AGGROPYTHAS            "Les anneaux de la mort vont vous broyer!"
...
#define SAY_AGGROSERPENTIS     		"Je suis le roi serpent, je fais ce que je veux!"
...
public:
    ...
    void AIUpdate()
    {
		...
		{
		_unit->SendChatMessage(CHAT_MSG_MONSTER_SAY, LANG_UNIVERSAL, "Prend la fuite dans un moment de panique");
		Run_in_fear = true;
		}
		if(Run_in_fear)
		{
...
public:
	...
	{		
		...
		if(!Mutanus || Mutanus->isAlive())
		{
			...
			Naralex->SendChatMessage(CHAT_MSG_MONSTER_SAY, LANG_UNIVERSAL, "Je suis éveillé, enfin!");
