...
public:
    ...
    EXARCHMALADAARAI(Creature* pCreature) : CreatureAIScript(pCreature)
    {
		...
		spells[0].speech = "Que votre esprit soit embrouillé.";
		...
		spells[1].speech = "Observez les ténèbres de votre âme!";
    ...
    void OnCombatStart(Unit* mTarget)
    {
		...
		{
		case 0: 
			_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Vous le paierez de votre vie!");
			_unit->PlaySoundToSet(10513);
			break;
		case 1:
			_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Il n’y a plus de retour possible!");
			_unit->PlaySoundToSet(10514);
			break;
		case 2:
			_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Accomplissez votre pénitence!");
	...
	void OnTargetDied(Unit* mTarget)
    {
		if (_unit->GetHealthPct() > 0)	// Hack to prevent double yelling (OnDied and OnTargetDied when creature is dying)
		{
			...
			{
			case 0: 
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Ces murs seront votre tombeau!");
				_unit->PlaySoundToSet(10516);
				break;
			case 1:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Haha, ainsi vous resterez, pour l’éternité! Mwahahah!"); // spelling check needed !
	...
	void OnDied(Unit * mKiller)
    {
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "C’est...ici...qu’est ma place...");
    ...
    void AIUpdate()
    {
		...
		{
			_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Levez vous mes frères tombé! prenez forme et battez vous!");
