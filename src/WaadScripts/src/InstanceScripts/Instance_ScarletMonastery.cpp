...
{
_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Lâchez les chiens!");
...
_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "C'est tout?");
...
break;
	...
	void ChangeToPhase1()
    {
        ...
        _unit->SendChatMessage(CHAT_MSG_MONSTER_SAY, LANG_UNIVERSAL, "Lumière, donne-moi la force!");
		HpEnrage();
    }
...
spells[1].soundid = AE;
spells[1].speech = "Brûlez dans les flammes de la vertu!";
...
void OnCombatStart(Unit* mTarget)
{
_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Vous ne dévoilerez pas les mystères!");
...
void OnCombatStart(Unit* mTarget)
{
_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Dites moi tout; tout.");
...
_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "La douleur vous purifiera!");
...
void OnCombatStart(Unit* mTarget)
{
_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Infidèles, ils doivent être purifiés!");
...
_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Indignes limaces.");
...
spells[2].speech = "Que mon champion se lève!";
}

void OnCombatStart(Unit* mTarget)
{
_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Mograine est tombé? Vous paierez pour cette trahison!");
...
_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "La lumière à parlé!");
...
break;
	...
	void ChangeToPhase1()
    {
		...
		/*_unit->SendChatMessage(CHAT_MSG_MONSTER_SAY, LANG_UNIVERSAL, "Light, give me strength!");
		       ^^ Notes for myself */ 
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Que mon champion se lève!");
			//MoveToRes();
			CastSleep();
			CastRes();
    }
...
public:
	...
	spells[0].speech = "Lames de lumière!"; 
	...
	spells[2].speech = "Que la lumière me donne la force!"; 

	}

	void OnCombatStart(Unit* mTarget)
	{
	_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Ah, j’espérais un vrai défi!");
	...
	void OnTargetDied(Unit* mTarget)
	{
		...
		if (_unit->GetHealthPct() > 0)    // Hack to prevent double yelling (OnDied and OnTargetDied when creature is dying)
        {
			...
			case 0:
				...
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Ha, c'est tout?");
