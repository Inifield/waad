...
public:
    ...
    NalorakkAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
    {
		...
		spells[1].speech = "Ca va faire mal!";
    ...
    {
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Vous serez mort bien vite!");
	...
	void OnTargetDied(Unit* mTarget)
    {
		if (_unit->GetHealthPct() > 0)	
		{
			...
			{
			case 0:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Les Amanis, ils vont regner a nouveau!");
				_unit->PlaySoundToSet(12076);
				break;
			case 1:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Alors qu'est ce que tu as a dire hein?");
    ...
    {
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Je... vous attendrai...de l'autre cote....");
		...
		if (_unit->GetCurrentSpell() == NULL)
		{
			if (t > FormTimer)
			{
				if (Form == NALORAKK_FORM_TROLL)
				{
					...
					_unit->SetFloatValue(OBJECT_FIELD_SCALE_X , 1.0f);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Vous demandez la bete, je vais vous donner la bete!");
				...
				else
				{
					...
					_unit->setAttackTimer(1500, false);
					_unit->SetFloatValue(OBJECT_FIELD_SCALE_X , 1.0f);
					_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Place! Voila le Nalorakk!");
			...
			if (t > spells[6].casttime)
			{
				...
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "C'etait votre chance, maintenant c'est trop tard!");	// check plx
...
public:
    ...
    void OnCombatStart(Unit* mTarget)
    {
		nrspells = 4;
		timesummon = 0;
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Moi je suis le predateur! Vous etes la proie!");
	...
	void OnTargetDied(Unit* mTarget)
    {
		if (_unit->GetHealthPct() > 0)	
		{
			...
			{
			case 0:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Arretez de pleurnicher!");
				_unit->PlaySoundToSet(12018);
				break;
			case 1:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "z'etes nul!");
    ...
    void OnDied(Unit * mKiller)
    {
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Mon esprit...vous pouvez pas...le tuer!");
		...
		if (timesummon > 300)
			{
				...
				timesummon = 0;
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Mangez, mes freres!");
				_unit->PlaySoundToSet(12014);
			}
...
public:
    ...
    void OnCombatStart(Unit* mTarget)
    {
		...
		spmin = 0;
		phase =1;
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "A genoux les idiots, devant la griffe et le croc!");
	...
	void OnTargetDied(Unit* mTarget)
    {
			if (_unit->GetHealthPct() > 0)	
		{
			...
			{
			case 0:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "J'ai trop la puissance pour vous...");
				_unit->PlaySoundToSet(12026);
				break;
			case 1:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "S'allez tous echouer...");
...
public:
    ...
    void OnCombatStart(Unit* mTarget)
    {
		...
		spmin = 0;
		phase =1;
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Les esprit du vent, ils vont être votre fin!");
	...
	void OnTargetDied(Unit* mTarget)
    {
			if (_unit->GetHealthPct() > 0)	
		{
			...
			{
			case 0:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "C'est fini pour toi!");
				_unit->PlaySoundToSet(12036);
				break;
			case 1:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "L'ombre, elle va vous tomber dessus!");
    ...
    void OnDied(Unit * mKiller)
    {
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Zul'jin...Il à une surprise pour vous...");
    ...
    void AIUpdate()
	{
		if (_unit->GetHealthPct() <= 50 && phase == 1) 
		{
			...
			nrspells = 4;
			phase = 2;
			_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Je vais vous cramer!");
		...
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Zou mes perce-coques! Au boulot! Faut que ca eclose!");
...
public:
	...
	void OnTargetDied(Unit* mTarget)
    {
				if (_unit->GetHealthPct() > 0)	
		{
			...
			case 0:
				...
				break;
			case 1:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Ce cauchemar là, vous allez pas vous en reveiller");
    ...
    void OnDied(Unit * mKiller)
    {
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "c'est pas la fin pour moi...");
       ...
       pDoor->SetByte( GAMEOBJECT_BYTES_1,0,0); //SetUInt32Value(GAMEOBJECT_STATE, 0); // Open the door
    }
...
public:
    ...
    void OnCombatStart(Unit* mTarget)
    {
		...
		spmin = 0;
		phase =1;
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "ya personne plus balaise que moi.");
	...
	void OnTargetDied(Unit* mTarget)
    {
					if (_unit->GetHealthPct() > 0)	
		{
			...
			{
			case 0:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Da Amani Di chuga");
				_unit->PlaySoundToSet(12098);
				break;
			case 1:
				_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Plein d'autre, ils vont tomber comme vous!");
    ...
    void OnDied(Unit * mKiller)
    {
		_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "J'suis peut-être vaincu...mais l'empire amani...il moura jamais...");
    ...
    void AIUpdate()
	{
		if (_unit->GetHealthPct() <= 80 && phase == 1) 
		{
			...
			_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "J'ai des nouveaux tours...comme mon frère ours!");
		...
		if (_unit->GetHealthPct() <= 60 && phase == 2) 
		{
			...
			_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "L'aige...il vous trouvera partout!");
		...
		if (_unit->GetHealthPct() <= 40 && phase == 3) 
		{
			...
			_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Je vous presente mes nouveaux frères: griffe et croc!");
		...
		if (_unit->GetHealthPct() <= 20 && phase == 4) 
		{
			...
			_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, "Pas besoin de lever les yeux au ciel pour voir le faucon-dragon!");
