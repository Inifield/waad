...
function OnCombat(unit)
	unit:Root()
	unit:SendChatMessage(CHAT_MSG_MONSTER_YELL,LANG_UNIVERSAL,"Mon pouvoir est dévastateur! Il est risible que ces mortels essayent même d'entrer dans mon royaume!")
