...
#define GET_ENTRY_FROM_GUID(x) ( ( x & 0x000FFFFFFF000000) >> 24 )
#else
...
std::string ConvertUnixTimeToString(uint32 timestamp);      // Renvoie "HH:MM:SS (dd-mm-yyyy)"
std::string ConvertMSTimeToString(uint32 timestamp);        // Renvoie "HH:MM:SS 100ieme"
