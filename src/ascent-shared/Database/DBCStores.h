...
ASCENT_INLINE uint32 GetDBCscalestatMultiplier(ScalingStatValuesEntry *ssvrow, uint32 flags)
{
	if(flags & 0x4001F)
	{
		if(flags & 0x00000001)
...
ASCENT_INLINE uint32 GetDBCscalestatArmorMod(ScalingStatValuesEntry *ssvrow, uint32 flags)
{
	if(flags & 0x00F001E0)
	{
		if(flags & 0x00000020)
...
ASCENT_INLINE uint32 GetDBCscalestatDPSMod(ScalingStatValuesEntry *ssvrow, uint32 flags)
{
	if(flags & 0x7E00)
	{
		if(flags & 0x00000200)
...
ASCENT_INLINE uint32 GetscalestatSpellBonus(ScalingStatValuesEntry *ssvrow)
{
