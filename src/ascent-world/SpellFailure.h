...
enum SpellCastError                                  // Message Client
{
	...
	SPELL_FAILED_ALREADY_HAVE_CHARM             = 6, // "Vous controlé deja une créature charmé"
	SPELL_FAILED_ALREADY_HAVE_SUMMON            = 7, // "Vous controlé deja une créature invoqué"
	...
	SPELL_FAILED_NO_DUELING                     = 79, // "Le dule n'est pas autorisé ici"
	...
	SPELL_FAILED_NOT_IN_BARBERSHOP              = 180, // "Vous ne pouvez pas faire ca dans un salon de coiffoire"
