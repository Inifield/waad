...
class SERVER_DECL WorldStateManager
{
    ...
    //typedef HM_NAMESPACE::hash_map<uint32, WorldState> WorldStateMap;
	// storing world database worldstate variables
	WorldStateMap m_DBStates;
...
public:
	...
	void CreateWorldState(uint32 uWorldStateId, uint32 uInitialValue, int32 iFactionId = FACTION_MASK_ALL, int32 iZoneId = ZONE_MASK_ALL);
