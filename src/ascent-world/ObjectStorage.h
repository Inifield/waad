...
extern SERVER_DECL SQLStorage<CreatureHeight, HashMapStorageContainer<CreatureHeight> >			CreatureHeightStorage; // Collision
extern SERVER_DECL SQLStorage<CreatureInfo, HashMapStorageContainer<CreatureInfo> >				CreatureNameStorage;
extern SERVER_DECL SQLStorage<SkillNames, ArrayStorageContainer<SkillNames> >					SkillNamesStorage; // Mizuka
...
extern SERVER_DECL SQLStorage<Quest, HashMapStorageContainer<Quest> >							QuestStorageLFG; //Pour les dongeons.
