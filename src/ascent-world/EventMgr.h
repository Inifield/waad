...
enum EventTypes
{
	...
	EVENT_VEHICLE_RESPAWN, // HearthStone 
	...
	EVENT_VEHICLE_SAFE_DELETE, // HearthStone
	EVENT_CREATURE_INTERNAL_DELETE,
	...
	EVENT_PLAYER_DELETE,
	// Ajout Alterac, Branruz
	EVENT_AV_RESOURCES_UPDATE_TEAM_0, 
	EVENT_AV_RESOURCES_UPDATE_TEAM_1, 
	EVENT_AV_CONTROL_CP00,
	EVENT_AV_CONTROL_CP01, 
	EVENT_AV_CONTROL_CP02, 
	EVENT_AV_CONTROL_CP03, 	
	EVENT_AV_CONTROL_CP04,       	    
	EVENT_AV_CONTROL_CP05,       
	EVENT_AV_CONTROL_CP06,
	EVENT_AV_CONTROL_CP07, 
	EVENT_AV_CONTROL_CP08, 
	EVENT_AV_CONTROL_CP09,       
	EVENT_AV_CONTROL_CP10, 	
	EVENT_AV_CONTROL_CP11,       
	EVENT_AV_CONTROL_CP12, 	   
	EVENT_AV_CONTROL_CP13, 
	EVENT_AV_CONTROL_CP14, 	 
	EVENT_AV_CONTROL_CP15, 
	EVENT_AV_CONTROL_CP16, 
	EVENT_AV_CONTROL_CP17, 
	EVENT_AV_CONTROL_CP18,
	// Ajouts WorldAnnounce, Cinemania
	EVENT_WORLDANNOUCE_CONTROL,
	EVENT_UNIT_SENDMESSAGE,
	EVENT_SOTA_TIMER, // 4ieme BG (Wrath)
	EVENT_BEACON_REMOVE,
	//EVENT_UNPOSSESS,
...
enum EventFlags
{
	EVENT_FLAG_EXECUTE_IN_WORLD_CONTEXT			= 0x0,
...
struct SERVER_DECL TimedEvent
{
	...
	*/
	...
	void DecRef()
	{
		...
		if(ref <= 0)
		{
			//Log.Warning("[EventableObjectHolder]","L'Event %d va etre supprime !!",this->eventType);
			delete cb;
			this->resultDecRef = true;
		}
	...
	{ 
        ...
        //Log.Warning("[IncRef]","(Ref:%d) L'Event %d est insere",ref,this->eventType);
	}
#else
...
public:
	...
	template <class Class> void RemoveEvents(Class *obj) { obj->event_RemoveEvents(EVENT_REMOVAL_FLAG_ALL); }
