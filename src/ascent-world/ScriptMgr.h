...
enum ServerHookEvents
{
	...
	SERVER_HOOK_EVENT_ON_CONTINENT_CREATE	= 29,
	SERVER_HOOK_EVENT_ON_POST_SPELL_CAST	= 30,
	SERVER_HOOK_EVENT_ON_AURA_REMOVE        = 31,
	SERVER_HOOK_EVENT_ON_DESTROY_BUILDING   = 32,
	SERVER_HOOK_EVENT_ON_DAMAGE_BUILDING    = 33,
...
typedef void(*tOnEmote)(Player * pPlayer, uint32 Emote, Unit * pUnit); // Marcelo's Patch for Sun ++ and WaadScripts
...
typedef void(*tOnQuestAccept)(Player * pPlayer, Quest * pQuest, Object * pQuestGiver); // Marcelo's Patch for Sun ++ and WaadScripts
...
typedef void(*tOnQuestFinished)(Player * pPlayer, Quest * pQuest, Object * pQuestGiver); // Marcelo's Patch for Sun ++ and WaadScripts
...
public:
	...
	virtual void OnActivatePosition(Player * pPlayer) {}
	virtual void OnZoneHook(Player *pPlayer, uint32 Zone, uint32 OldZone) {}
	virtual void AIUpdate() {}
	virtual void Destroy() {}
...
public:
	...
	//This method is used for ALL target types
	virtual bool IsValidSpellTarget(Object* obj) { return true; }
	//This method is used for scripted target types
	virtual bool IsValidTarget(Object* obj) { return false; }
	virtual void OnAuraAdd(Aura* a) {}
	virtual void EventPeriodicScript(Aura *pCallingAura) {}

	void CallSpellUpdate();
...
public:
    ...
    virtual bool OnQuestCanBeFinished(Player* mTarget, QuestLogEntry *qLogEntry) { return(true); }
...
public:
	...
	void OnEmote(Player * pPlayer, uint32 Emote, Unit * pUnit); // Marcelo's Patch for Sun ++ and WaadScripts
	...
	void OnQuestAccept(Player * pPlayer, Quest * pQuest, Object * pQuestGiver); // Marcelo's Patch for Sun ++ and WaadScripts
	...
	void OnQuestFinished(Player * pPlayer, Quest * pQuest, Object * pQuestGiver); // Marcelo's Patch for Sun ++ and WaadScripts
