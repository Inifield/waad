...
// ChatChannels.dbc, 335.12340
#define CHANNEL_GENERAL				 1
#define CHANNEL_COMMERCE			 2
#define CHANNEL_DEFENSE_LOCAL		22
#define CHANNEL_DEFENSE_UNIVERSELLE	23
#define CHANNEL_RECRUTEMENT_GUILDE	25
#define CHANNEL_RECHERCHE_GROUPE	26
