...
public:
	...
	// Custom
	ASCENT_INLINE uint32 GetFromNode(void) { return from; }
	ASCENT_INLINE uint32 GetToNode(void) { return to; }
	ASCENT_INLINE void SetFromNode(uint32 fromNode) { from = fromNode; }
	ASCENT_INLINE void SetToNode(uint32 toNode) { to = toNode; }
	ASCENT_INLINE void SetNodePrice(uint32 NodePrice) { price = NodePrice; }
	ASCENT_INLINE void SetNodeMap1(uint32 NodeMap1) { m_map1 = NodeMap1; }
	ASCENT_INLINE void SetNodeMap2(uint32 NodeMap2) { m_map2 = NodeMap2; }
...
public:
	...
	void GetTaxiNodeFromTo(uint32 TaxiNodeId,uint32 *fromNode, uint32 *toNode);
