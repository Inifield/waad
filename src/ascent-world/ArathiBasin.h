...
protected:
	...
	// Ajout Branruz, pour Honneur sur Drap Defendu
	// Index 0 = Drap defendu, Index 1 = Debut du Bg aucun drap n'a ecore été pris
...
public:
	...
	const char * GetName() { return "le bassin d'Arathi"; }
	void OnStart();
