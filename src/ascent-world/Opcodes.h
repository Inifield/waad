...
// Fonctionnement des NPCFlags : Propre a la base et essentiellement géré coté serveur,
//                               Certains NPCFlags sont 'primaire' et declenchent des messages CMSG_xxxxx
//                               Si le PNJ possede SEULEMENT le flag  UNIT_NPC_FLAG_GOSSIP, il enverra CMSG_NPC_TEXT_QUERY
//                               Si le PNJ possede le flag  UNIT_NPC_FLAG_GOSSIP acompagné d'un autre flag 'Secondaire',
//                               le message differe et devient par exemple CMSG_GOSSIP_HELLO
//                               Les flags 'tertiare' sont des flags destinés a differentier eventuellement se que fait le Pnj,
//                               le code n'est géré que coté serveur et il n'existe aucune interaction coté client connu
// Note sur UNIT_NPC_FLAG_DIRECTTAXI: Ce flag n'existe pas chez blizz et est une astuce pour que le player puisse 
//                                    prendre directement un griffon (Cf: Les griffons du fort d'ebene)
//                                    Il faut cependant le flag UNIT_NPC_FLAG_GOSSIP (declenchement du message CMSG_GOSSIP_HELLO)

enum NPCFlags {
//									Hex				Decimal			Bit  Comments
	UNIT_NPC_FLAG_NONE				= 0x00000000,	//0,			01
	UNIT_NPC_FLAG_GOSSIP			= 0x00000001,	//1,			02	Gossip/Talk (CMSG_GOSSIP_HELLO / tout seul = CMSG_NPC_TEXT_QUERY )
	UNIT_NPC_FLAG_QUESTGIVER		= 0x00000002,	//2,			03	Questgiver
	UNIT_NPC_FLAG_DIRECTTAXI      	= 0x00000004,	//4,			04  Flag specifique sur prise direct de Taxi sans flag TaxiVendor
	UNIT_NPC_FLAG_UNK2				= 0x00000008,	//8,			05
	UNIT_NPC_FLAG_TRAINER			= 0x00000010,	//16,			06	Trainer (CMSG_TRAINER_LIST)
	_UNIT_NPC_FLAG_TRAINER_CLASS	= 0x00000020,	//32,			07  Avec Flag Trainer: Specif si entraineur de classe (non géré directement)
	_UNIT_NPC_FLAG_TRAINER_PROF	    = 0x00000040,	//64,			08  Avec Flag Trainer: Specif si entraineur de profession (non géré directement)
	UNIT_NPC_FLAG_VENDOR			= 0x00000080,	//128,			09	Vendor (CMSG_LIST_INVENTORY)
	_UNIT_NPC_FLAG_VENDOR_AMMO		= 0x00000100,	//256,			10  Avec Flag Vendor: Specif si vendeur d'armes (non géré directement)
	_UNIT_NPC_FLAG_VENDOR_FOOD		= 0x00000200,	//512,			11  Avec Flag Vendor: Specif si vendeur de nourriture (non géré directement) 
	_UNIT_NPC_FLAG_VENDOR_POISON	= 0x00000400,	//1024,			12  Avec Flag Vendor: Specif si vendeur de poissons (non géré directement)
	_UNIT_NPC_FLAG_VENDOR_REAGENT	= 0x00000800,	//2048,			13  Avec Flag Vendor: Specif si aubergiste (non géré directement)
	UNIT_NPC_FLAG_ARMORER			= 0x00001000,	//4096,			14
	UNIT_NPC_FLAG_TAXIVENDOR		= 0x00002000,	//8192,			15	Taxi Vendor (Tout seul = CMSG_TAXIQUERYAVAILABLENODES)
	UNIT_NPC_FLAG_TRAINER_PROF		= 0x00004000,   //16384              A mon avis, celui la est une erreur (Branruz - 09/03/2010)
	UNIT_NPC_FLAG_SPIRITHEALER      = 0x00008000,       //16384			16		guessed
...
// HearthStone
enum GossipIcons {
	GOSSIP_ICON_GOSSIP_NORMAL		= 0, // Bulle (   )^
	GOSSIP_ICON_GOSSIP_VENDOR		= 1, // Bourse
	GOSSIP_ICON_GOSSIP_FLIGHT		= 2, // Petite Aile
	GOSSIP_ICON_GOSSIP_TRAINER		= 3, // Bouquin
	GOSSIP_ICON_GOSSIP_ENGINEER1	= 4, // Engrenage
	GOSSIP_ICON_GOSSIP_ENGINEER2	= 5, // Engrenage
	GOSSIP_ICON_GOSSIP_AUCTION		= 6, // Lingot d'or
	GOSSIP_ICON_GOSSIP_EXTRA		= 7, // Bulle et ... (...)^
	GOSSIP_ICON_GOSSIP_TABARD		= 8, // Tabard
	GOSSIP_ICON_GOSSIP_ARENA		= 9, // Epées croisées
	GOSSIP_ICON_GOSSIP_COIN			= 9,
};

// Define pour menu des Gossips gérés via le core (ScriptMgr.cpp)
// GossipScript::GossipHello et GossipScript::GossipSelectOption 
#define GOSSIP_OPTION_PATHFINDER     1
#define GOSSIP_OPTION_QUESTGIVER	 2     
#define GOSSIP_OPTION_VENDOR		 3
#define GOSSIP_OPTION_TAXI			 4
#define GOSSIP_OPTION_TRAINER		 5
#define GOSSIP_OPTION_SPIRIT		 6
#define GOSSIP_OPTION_SPIRITGUIDE	 7
#define GOSSIP_OPTION_INNKEEPER		 8
#define GOSSIP_OPTION_BANK			 9
#define GOSSIP_OPTION_PETITION		10
#define GOSSIP_OPTION_TABARDVENDOR	11
#define GOSSIP_OPTION_BATTLEFIELD	12
#define GOSSIP_OPTION_AUCTIONNER	13
#define GOSSIP_OPTION_STABLEPET		14
#define GOSSIP_OPTION_ARMORER		15
#define GOSSIP_OPTION_TALENTRESET	16
#define GOSSIP_OPTION_UNTRAINPET	17
#define GOSSIP_OPTION_DUAL_TALENT	18
#define GOSSIP_OPTION_TALENTRESET_MENU    90
#define GOSSIP_OPTION_UNTRAIN_MSG         91
#define GOSSIP_OPTION_DUAL_SPE_MENU       92
#define GOSSIP_OPTION_INNKEEPER_HELP_MENU 93
#define GOSSIP_OPTION_ABORTING_ACTION	  99
