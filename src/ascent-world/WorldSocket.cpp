...
/* OBSOLETE 322
	...
	// Si playerLimit = 0 , seulement les GMs peuvent se connecter, secu pour serveur de test
	// sinon mise du player en file d'attente, serveur plein!!
...
void WorldSocket::Authenticate()
{
	...
	if(pSession->HasFlag(ACCOUNT_FLAG_XPACK_02)) // 3.0.3, Woltk
